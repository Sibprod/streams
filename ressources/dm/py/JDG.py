...
def snif(line):
    try:
        ...
        url = f'https://www.dailymotion.com/player/metadata/video/k5VKYQn5hAE4vfry927?embedder=https://www.journaldugolf.fr ,proxies=proxies'
...
with open('ressources/dm/py/DMTV.txt') as f:
